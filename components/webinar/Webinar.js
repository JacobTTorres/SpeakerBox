  ...
  return (
    <div className="webinarContainer">
      <div className="webiLeft">
        <h1 className="webiHeader">Sign up for our latest webinar</h1>
        <p className="webiUnderHeader">
          Integrating Podcast Into Your Content Marketing Strategy will walk you
          through every step of involve with launching a podcast for your
          business.
        </p>
